...
def run_pygame_window():
    ...
    while running:
        ...
        text = font.render("Osiris Laboratory — Console Gameplay Active", True, (200, 180, 255))
...
class AlchemyGame:
    ...
    def comment_on_recipe(self, recipe):
        type_text(f"📜 Recipe analysis: {recipe.comment}\n", delay=0.015)
    ...
    def play(self):
        ...
        while True:
            ...
            if match:
                print(f"\n✨ You created: **{match.name}**! Power value = {match.result_value} ✨\n")
